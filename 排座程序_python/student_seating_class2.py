...
class StudentGroupingSystem:
    def __init__(self, excel_file=None):
        # 默认的Excel文件路径
        default_excel_path = '/Users/xushida/Nutstore Files/我的坚果云/大连交通大学(新)/教学/2025秋-最优化导论/教学班2（36人）——物流243、物流244/第二教学班-选课学生名单.xlsx'
    ...
    def export_to_excel(self, groups: Dict[str, List[Student]], filename: str = "学生分组排座结果class2.xlsx"):
        """导出分组结果到Excel文件"""
        # 准备数据
        data = []
...
if __name__ == "__main__":
    # 初始化系统，指定Excel文件路径
    excel_file = "/Users/xushida/Nutstore Files/我的坚果云/大连交通大学(新)/教学/2025秋-最优化导论/教学班2（36人）——物流243、物流244/第二教学班-选课学生名单.xlsx"
